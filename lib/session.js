  ...
  await prisma.character.createMany({
    data: [
      ...
      },
      {
        ...
        weaknesses:
          "Commitment issues, gambling addiction, fear of abandonment",
      },
    ],
  });
  ...
  await prisma.magic.createMany({
    data: [
      ...
      },
      {
        ...
        costs: "Moral corruption, risk of soul fragmentation, societal exile.",
        examples:
    ...
    data: [
      {
        ...
        location:
          "The Shattered Isles (formerly known as the Starlight Archipelago)",
