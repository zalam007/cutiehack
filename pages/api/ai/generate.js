...
export default async function handler(req, res){
  ...
  const suggestions = {
    ...
    backstory: "They once served the crown, but betrayed their oath after discovering dark secrets.",
    expand: "Further details: they carry a sigil etched in silver, a reminder of their fallen order."
  }
